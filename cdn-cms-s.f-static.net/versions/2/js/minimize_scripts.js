...
function ShowMenuAfterReduseSize($place) {
    ...
    if ($('#header').length == 0 && $('#top-menu').length > 0 && $place == 'header') {
        ...
        $('#mainNav .site_container').children().each(function() {
            rectMenu += Math.round(this.offsetWidth);
        });
        var $replaceActionButtonsToIcon = $('.replaceActionButtonsToIcon').length > 0 ? $('.replaceActionButtonsToIcon') : $('<li class="header-menu-wrapper replaceActionButtonsToIcon dropdown-submenu"><a data-close-location="left" class="btn" role="button" data-container="body" data-toggle="menuCallActionIcons">' + S123.s123IconToSvg.getHtml('bars', '', '') + '</a><ul class="site-dropdown-menu" data-rel="navActions" style="opacity: 1;"></ul></li>');
        if ($('#mainNavMobile').is(":visible") == false && rectMenu > rectHeader && $('#top-menu .navActions .header-menu-wrapper').length == 0 && $('#top-menu.affix').length == 0) {
            ...
            $replaceActionButtonsToIcon.find('.site-dropdown-menu').append($('.action-button-wrapper'));
            TriggerS123PageReady();
            ResetMoreButton();
        }
        ...
        if ($('#mainNavMobile').is(':visible') == false && rectMenu > rectHeader && $('#top-menu .navActions .header-menu-wrapper').length > 0 && $('.replaceActionButtonsToIcon').length > 0 && $('.replaceActionButtonsToIconRemoveExtra').length == 0 && $('#top-menu.affix').length == 0) {
            $replaceActionButtonsToIcon.find('.site-dropdown-menu').append($('#top-menu').find('.header-phone-wrapper, .header-address-wrapper, .header-social-wrapper, .header-search-wrapper, .header-email-wrapper'));
