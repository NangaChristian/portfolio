    ...
    $(document).on('s123.page.ready', function(event) {
        ...
        $section.each(function(index) {
            ...
            $sectionThis.find('.jobsApplyBtn').click(function() {
                ...
                var customApplicationForm = $sectionThis.find('#customApplicationForm');
                var w = $('#w').val();
                buildPopup('popupJobs', '', buildForm(websiteID, moduleID, uniqueID, w, uploadFile, customForm, customApplicationForm), '', true, false, true, '', '');
